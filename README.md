...
📄 **paper.Rmd**: R Markdown source document for manuscript. Includes code to reproduce the figures and tables generated by the analysis. It also has a rendered version, paper.docx, suitable for reading (the code is replaced by figures and tables in this file)   
📄 **paper.pdf**: PDF file resulting from the rendering of the R Markdown source document. Inlcudes code and the figures produced by the code     
📁 **data**: Data used in the analysis.   
📁 **figures**: Plots and other illustrations   
📁 **supplementary-materials**: Supplementary materials from https://github.com/garveyr/ctsimulation   

# How to use

The simplest way to explore the text, code and data is to click on the [binder](https://mybinder.org/v2/gh/benmarwick/ctsimulation/master?urlpath=rstudio) button above to open an instance of RStudio in your browser, which will have the compendium files ready to work with. Binder uses rocker-project.org Docker images to ensure a consistent and reproducible computational environment. These Docker images can also be used locally.

You can download the compendium as a zip from from this URL: [master.zip](/archive/master.zip). After unzipping, open the Proj file in RStudio, then open paper.Rmd and knit to produce the paper.pdf.
