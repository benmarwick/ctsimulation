...
```{r}
data <- read.csv("Garvey_data.csv", skip = 6)
str(data)
```
...
```{r}
knitr::include_graphics("Garvey_Figure3a.pdf")
```
...
```{r}
knitr::include_graphics("Garvey_Figure3b.pdf")
```
